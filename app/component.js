...
class Component extends DCLogic {
  ...
  /* The month the map is showing.  The Resource view carries its own month so it can look at any
     month of the manpower table, not only the ones the timeline happens to be opened up to. */
  _resMon(){
    if(this._resExportOnly)return this._resExportMonth||'';
  ...
  buildSchedule(){
    ...
    { const _ms=this.root.querySelector('#schedMonths');
      if(_ms){ const MM=this.visMonths(); const curL=this.actCurLabel();   /* 排程视图也遵守 admin 的月份上限: 非 admin 看不到上限之后的月份 */
