...
class Component extends DCLogic {
  ...
  bindGlobal(){
    ...
    {const _la=this.root.querySelector('#openLookAhead');if(_la)_la.addEventListener('click',()=>{this._reportCombined=false;this._reportEditing=false;this.openLookAhead();});}
