...
class Component extends DCLogic {
  ...
  _canSeeActCmt(c,lv,zmk){if(this.rwsIsAdmin())return true;if(!c)return false;if(c.to==='Planning')return this.rwsIsPlanning();if(c.to==='PM')return this.rwsScopeOk(lv,zmk);return false;}
  _canResolveActCmt(c,lv,zmk){return this._canSeeActCmt(c,lv,zmk);}
